                        ...
                        <form action="{{ url('/movies') }}" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="movie_name" name="movie_name" placeholder="Nombre de la película">
                                </div>
                                <div class="form-group">
                                    <label for="movie_synopsis">Sinopsis</label>
                                    <input type="text" class="form-control" id="movie_synopsis" name="movie_synopsis" placeholder="Sinopsis de la película">
                                </div>
                                <div class="form-group">
                                    <label for="movie_unit_price">Precio unitario</label>
                                    <input type="text" class="form-control" id="movie_unit_price" name="movie_unit_price" placeholder="Precio unitario de la película">
                                </div>
                                <div class="form-group">
                                    <label for="movie_genre">Género</label>
                                    <input type="text" class="form-control" id="movie_genre" name="movie_genre" placeholder="Género de la película">
                                </div>
                                <div class="form-group">
                                    <label for="movie_release_date">Fecha de estreno</label>
                                    <input type="date" class="form-control" id="movie_release_date" name="movie_release_date" placeholder="Fecha de estreno de la película">
                                </div>
                                <div class="form-group">
